                            ...
                            <ul class="nav" id="side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        ...
                                        <li>
                                            <a href="?url=fiches&etat=VA">Les fiches validées</a>
                                        </li>
                                        <li>
                                            <a href="?url=fiches&etat=RB">Les fiches remboursées</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-second-level -->
                                </li>
                                ...
                                <li>
                                    <a href="?url=fiches&etat=CL"><i class="fa fa-pencil fa-fw"></i> Les fiches à valider</span></a>
